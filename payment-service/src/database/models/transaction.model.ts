...
export enum TransactionStatus {
    ...
    RECONCILED = 'reconciled', // Admin-driven adjustment offsetting an earlier transaction (e.g., reversing a ghost commission or activation transfer). Carries audit metadata referencing the original.
}
